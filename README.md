...
main.html: The main landing page of the website.
nav.css: CSS rules for the navigation bar across the website.
no-transition-on-resize.js: JavaScript file to disable animations during window resizing.
service.html: Describes the services I offer through my professional work.
